<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FairsList.ascx.cs" Inherits="FairsList" %>
<div>
    <div id='headerDiv'>
        <asp:Label ID="lblFairsList" runat="server" Text="Fairs List"></asp:Label>
    </div>
    <div id='filterDiv'>
    ...
    <div id='dataDiv'>
        <asp:GridView ID="grdFairs" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            OnRowCommand="grdFairs_RowCommand">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
