<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MostLikedCtrl.ascx.cs"
    Inherits="MostLikedCtrl" %>
<div class="section">
    <h2>
        <asp:Literal ID="ltrlTitle" runat="server" Text="<%$ Resources:Literals, MostLiked %>"></asp:Literal>
    </h2>
    <div class="box2 round shadow">
        <asp:Repeater ID="rptMostLiked" runat="server">
            <ItemTemplate>
                <div>
