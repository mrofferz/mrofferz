<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OffersListCtrl.ascx.cs"
    Inherits="OffersListCtrl" %>
                ...
                <asp:Repeater ID="rptResult" runat="server">
                    <ItemTemplate>
                        <div>
                            ...
                            </span><span id='newPriceSpan' class="foucs" runat="server" visible='<%# Convert.ToBoolean(Eval("IsProduct")) %>'>
                                <%# Eval("NewPrice") %>
                                <b>
